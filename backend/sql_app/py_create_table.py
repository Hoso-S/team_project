...
ddl_teaches = """CREATE TABLE IF NOT EXISTS teaches
	(ID			varchar(5), 
	 course_id		varchar(8),
	 sec_id			varchar(8), 
	 semester		varchar(6),
...
ddl_advisor = """CREATE TABLE IF NOT EXISTS advisor
	(s_ID			varchar(5),
	 i_ID			varchar(5),
	 primary key (s_ID),
...
ddl_prereq = """CREATE TABLE IF NOT EXISTS prereq
	(course_id		varchar(8), 
	 prereq_id		varchar(8),
